...
function initCellElementList() {
   ...
   * thay vì thêm sự kiện click vô từng thẻ li, thì mình thêm sự kiện click vô thẻ ul
   * vì khi click vô thẻ li sẽ bubbling lên thẻ cha của nó là ul
   */
